...
class Atri:
	def __init__(self, state: Any):
		...
		self.InfoAsset = state["InfoAsset"]
		self.Precision = state["Precision"]
		self.Ticker = state["Ticker"]
		self.Name = state["Name"]
		self.AssetHash = state["AssetHash"]
	...
	def Background(self, new_state):
		...
		global default_state
		self._Background = Flex(new_state, default_state["Background"])
	...
	@property
	def InfoAsset(self):
		self._getter_access_tracker["InfoAsset"] = {}
		return self._InfoAsset
	@InfoAsset.setter
	def InfoAsset(self, new_state):
		self._setter_access_tracker["InfoAsset"] = {}
		global default_state
		self._InfoAsset = Flex(new_state, default_state["InfoAsset"])
	...
	@Precision.setter
	def Precision(self, new_state):
		self._setter_access_tracker["Precision"] = {}
		global default_state
		self._Precision = Flex(new_state, default_state["Precision"])

	@property
	def Ticker(self):
		self._getter_access_tracker["Ticker"] = {}
		return self._Ticker
	@Ticker.setter
	def Ticker(self, new_state):
		self._setter_access_tracker["Ticker"] = {}
		global default_state
		self._Ticker = Flex(new_state, default_state["Ticker"])
	...
	def Name(self, new_state):
		...
		global default_state
		self._Name = Flex(new_state, default_state["Name"])

	@property
	def AssetHash(self):
		self._getter_access_tracker["AssetHash"] = {}
		return self._AssetHash
	@AssetHash.setter
	def AssetHash(self, new_state):
		self._setter_access_tracker["AssetHash"] = {}
		global default_state
		self._AssetHash = Flex(new_state, default_state["AssetHash"])
	...
	@property
	def LinkHome(self):
		self._getter_access_tracker["LinkHome"] = {}
		return self._LinkHome
	@LinkHome.setter
	def LinkHome(self, new_state):
		self._setter_access_tracker["LinkHome"] = {}
		global default_state
		self._LinkHome = Link(new_state, default_state["LinkHome"])
